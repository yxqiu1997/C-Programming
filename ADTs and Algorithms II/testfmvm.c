...
int main(void)
{
    ...
    /* Get hash number */
    assert((int)getHash("frog") == 128772);
    ...
    str = mvm_print(m);
    i = strcmp(str, "[dog](bark) [cat](meow) [frog](croak) [bird](tweet) [horse](neigh) ");
    assert(i==0);
    free(str);
    ...
    assert(mvm_size(m)==4);
    str = mvm_print(m);
    i = strcmp(str, "[cat](meow) [frog](croak) [bird](tweet) [horse](neigh) ");
    assert(i==0);
    free(str);
    mvm_delete(m, "frog");
    assert(mvm_size(m)==3);
    ...
    assert(mvm_size(m)==5);
    str = mvm_print(m);
    i = strcmp(str, "[cat](meow) [frog](croak) [frog](ribbit) [bird](tweet) [horse](neigh) ");
    free(str);
    assert(i==0);
