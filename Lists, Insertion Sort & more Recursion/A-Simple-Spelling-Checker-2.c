...
int isLetter(char c);
char **binarySort(char **array, int cnt);
...
int main(void)
{
    ...
    int cnt = 0;
    FILE *fp = fopen("D:/GitHub/Programming-in-C/Lists, Insertion Sort & more Recursion/34words.txt","r");
