...
int main(void)
{
    ...
    char *s="D:/GitHub/Programming-in-C/Strings, Recursion and SDL/eng_370k_shuffle.txt";
...
void printOut(Hashmap *hashmap, int *prime)
{
    FILE *fp = fopen("D:/GitHub/Programming-in-C/Strings, Recursion and SDL/result.txt","w");
    int i, j;
    int hashnext;
